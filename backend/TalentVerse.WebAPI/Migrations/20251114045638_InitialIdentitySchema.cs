        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposerUserSkillId = table.Column<int>(type: "integer", nullable: false),
                    RecipientUserSkillId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proposals_AspNetUsers_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_UserSkills_ProposerUserSkillId",
                        column: x => x.ProposerUserSkillId,
                        principalTable: "UserSkills",
                        principalColumn: "UserSkillId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_UserSkills_RecipientUserSkillId",
                        column: x => x.RecipientUserSkillId,
                        principalTable: "UserSkills",
                        principalColumn: "UserSkillId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ProposalId",
                table: "Appointments",
                column: "ProposalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proposals_ProposerUserSkillId",
                table: "Proposals",
                column: "ProposerUserSkillId");

            migrationBuilder.CreateIndex(
                name: "IX_Proposals_RecipientId",
                table: "Proposals",
                column: "RecipientId");

            migrationBuilder.CreateIndex(
                name: "IX_Proposals_RecipientUserSkillId",
                table: "Proposals",
                column: "RecipientUserSkillId");
